...
- **Native Integrations**: Vision Camera, Firebase Cloud Messaging, Notifee, Geolocation, App Auth (OAuth), Signature Canvas, Reanimated, Gesture Handler
- **Backend**: Frappe/ERPNext-based REST API with custom endpoints for HR and FSM modules
